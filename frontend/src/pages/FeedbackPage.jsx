      ...
      <main className="max-w-lg mx-auto px-4 py-8 md:py-12">
        <div className="card">
          ...
          <p className="text-muted text-sm mb-6">
            Share suggestions to help improve city services.
          </p>
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {error && (
                <p className="text-error text-sm p-3 rounded-xl bg-red-50 dark:bg-red-900/20">
                  {error}
                </p>
              )}
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. App usability, response time"
                  value={form.problem}
